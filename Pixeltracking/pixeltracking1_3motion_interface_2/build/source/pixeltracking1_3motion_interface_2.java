...
public class pixeltracking1_3motion_interface_2 extends PApplet {
...
public void draw(){
  ...
  for(int x=0; x < video.width; x++){
    for(int y=0; y < video.height; y++){
      ...
      int currentColor1 = video.pixels[loc];
      ...
      int prevColor1 = prev.pixels[loc];
  ...
  lerpX = lerp(lerpX, motionX, 0.58f);
  lerpY = lerp(lerpY, motionY, 0.58f);
  //fill(#18FF0D);
  //strokeWeight(2);
  //stroke(0);
...
public float distSq(float x1, float y1, float z1, float x2, float y2, float z2){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "pixeltracking1_3motion_interface_2" };
    if (passedArgs != null) {
